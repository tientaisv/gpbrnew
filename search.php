...
<span xmlns:v="http://rdf.data-vocabulary.org/#"><a class="home" href="<?php echo esc_url(home_url()); ?>" typeof="v:Breadcrumb"><?php _e('Trang chủ', 'theme'); ?></a> <span class="separator"><i class="sep fa-icon-double-angle-right"></i></span><?php echo __('Kết quả tìm kiếm từ khóa', 'theme').' "'.$s.'"'; ?></span></div></div>
                </div>
                <?php } ?>
                    ...
                    <div class="advanced-search-form base-box">
                        <form action="<?php echo home_url('/'); ?>">
                            ...
                            <label for=""><?php _e('Thời gian:', 'theme'); ?></label>
                            ...
                            <label for=""><?php _e('Loại tin:', 'theme'); ?></label>
                            <div class="mom-select">
...
<div class="base-box blog-post default-blog-post">
    <div class="bp-entry">
        <div class="bp-head">
                                <h2><?php _e('Kết quả cho:', 'theme'); echo ' "'.$s.'" ';  _e('did not match','theme'); ?></h2>
        </div> <!--blog post head-->
        ...
        <?php  endif; ?>
                ...
                <div class="news-box base-box">
                    <header class="nb-header">
                        <h2 class="nb-title"><span><?php echo __('Kết quả:', 'theme').' "'.$s.'"'; ?></span></h2>
                    </header> <!--nb header-->
