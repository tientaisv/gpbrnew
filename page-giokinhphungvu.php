<?php 
/*
 Template Name: Gio kinh phung vu Page
*/
        ...
        <?php if ($layout == 'fullwidth') { ?>
                ...
                <?php } else { ?>
                        ...
                        <div class="entry-content">
						 <div class="kinhphungvu-content">
								<iframe src="https://ktcgkpv.org/readings/prayer" width="500px" height="800px" scrolling="no" style="height: 1229px;"></iframe>
								</div>
