...
add_image_size('small-wide2', 90, 70, true);
add_image_size('small-wide2-hd', 180, 140, true);
add_image_size('related-posts', 236, 140, true);
...
add_image_size('news_list_img', 320, 200, true);
add_image_size('news_list_img_hd', 640, 400, true);
...
'small-wide2' => array(90, 70),
'small-wide2-hd' => array(180, 140),
'news_list_img' => array(320, 200),
'news_list_img_hd' => array(640, 400),
'related-posts' => array(236, 140),
...
<?php echo $chat_bottom_content; ?>
      <?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Trang:', 'theme' ), 'after' => '</div>' ) ); ?>
    <?php
...
*/
// show related post by tag
if(has_tag(2032)){

	mom_related_sukien(2032);
}
	else if ($DRP != 1){
		 mom_related_posts();
	}
