...
<?php if ($style == 'vertical') { ?>
        ...
        <?php if (mom_option('post_share_facebook') != false) { ?>
            <div class="ss-icon facebook facebook-<?php echo $id; ?>">
			  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url;?>" target="_blank">Chia sẽ Facebook</a>
                <!--<a href="#" onclick="window.open('https://www.facebook.com/dialog/feed?app_id=240099799700243&display=popup&caption=<?php echo $title;?>&show_error=true&link=<?php echo $url; ?>&picture=<?php echo $img; ?>&redirect_uri=<?php echo $url; ?>&name=<?php echo $title;?>', '<?php echo $window_title; ?>', 'menubar=no,toolbar=no,resizable=no,scrollbars=no, width=<?php echo $window_width; ?>,height=<?php echo $window_height; ?>');"><span class="icon"><i class="fa-icon-facebook"></i><?php _e('Share', 'theme'); ?></span></a>
...
<?php } else { // horizontal here ?>
       <div class="mom-social-share ss-horizontal border-box php-share" data-id="<?php echo $id; ?>">
        <?php if (mom_option('post_share_facebook') != false) { ?>
            <div class="ss-icon facebook">
                <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?php echo $url;?>', 'menubar=no,toolbar=no,resizable=no,scrollbars=no, width=<?php echo $window_width; ?>,height=<?php echo $window_height; ?>');">
				<span class="icon"><i class="fa-icon-facebook"></i><?php _e('Share', 'theme'); ?></span></a>
                <span class="count"><?php echo $facebook; ?></span>
            </div> <!--icon-->
        <?php } ?>
