...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Goodnews Shortcode editor', // The plugin name
			'slug'     				=> 'goodnews-shortcode-editor', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/framework/plugins/goodnews-shortcode-editor.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
